      ...
      <div className="relative z-10">
        ...
        <section className="container mx-auto px-6 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Mit KI-Angebotsgenerierung und automatischer Bundle-Erstellung.
              Verkaufe Affiliate, KI-Blog und Business Websites auf Knopfdruck.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 border border-white/20 shadow-2xl">
              ...
              <div className="mb-8">
                ...
                >
                  {(["AFFILIATE", "AI_BLOG", "BUSINESS"] as const).map(
                    (type) => (
                      <button
                        key={type}
                        onClick={() => setWebsiteType(type)}
                        aria-pressed={websiteType === type}
                        className={`py-4 px-6 rounded-2xl font-semibold transition-all duration-300 focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:outline-none ${
                          websiteType === type
            ...
            {[
              {
                icon: "⚡",
                title: "Blitzschnell",
                desc: "Generiere Angebote in Sekunden",
              },
              {
                icon: "🎨",
                title: "Modern Design",
                desc: "Futuristisches UI mit Dark Mode",
              },
        ...
        <footer className="backdrop-blur-md bg-white/5 border-t border-white/10 mt-20">
          <div className="container mx-auto px-6 py-8 text-center text-gray-400">
            <p>
              © 2025 WebProjekte Verkauf System. Made with 💜 by Tech-lab-sys
            </p>
          </div>
        </footer>
      </div>
