            ...
            <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 border border-white/20 shadow-2xl">
              ...
              <form onSubmit={handleGenerateOffer}>
                ...
                <fieldset className="mb-8">
                  <legend className="block text-sm font-semibold text-gray-300 mb-4">
                    Website-Typ
                  </legend>
                    ...
                    {(["AFFILIATE", "AI_BLOG", "BUSINESS"] as const).map(
                      (type) => (
                        <button
                          ...
                          className={`py-4 px-6 rounded-2xl font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 ${
                            websiteType === type
